...
var orm = {
    ...
    selectAll: function(callback) {
        ...
        // Run MySQL Query
        connection.query('SELECT * FROM workout', function(err, result) {
            if (err) throw err;
            callback(result);
        });
    ...
    // insertOne()
    insertOne: function(workout, callback) {
        ...
        // Run MySQL Query
        connection.query('INSERT INTO workout SET ?', {
            workout: workout,
            sets: "",
            rep1: "",
            rep2: "",
    ...
    // updateOne()
    updateOne: function(workout, callback) {

        // Run MySQL Query
        connection.query('UPDATE workout SET ? WHERE ?', [{ KilledIt: true }, { id: workoutID }], function(err, result) {
            if (err) throw err;
            callback(result);
        });
